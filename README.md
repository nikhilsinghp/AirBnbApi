...
A full-featured Spring Boot backend application that provides REST APIs for an Airbnb-like hotel management system.  
The system supports hotel onboarding, room & inventory management, booking flow, payments, user authentication, and hotel search.
...
git clone https://github.com/nikhilsinghp/AirBnbApi.git
cd AirBnbApi
